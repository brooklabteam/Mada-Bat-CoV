#!/bin/bash
#SBATCH --job-name=extendOneRecomStr
...
/global/home/users/cbrook/beast/bin/beast -beagle_cpu -seed 777 -resume /global/scratch/users/cbrook/extend-nobeco-recomb/MadaBatCoV.xml
