...
2. Next, I downloaded one I added our three full-genome Madagascar bat-CoVs from IDseq. These are the contig names:
 - RR034B_010_NODE_1_length_29122_cov_127.557574 (*Pteropus rufus*)
...
4. From there, I uploaded the concentenated fasta into the MAFFT program online for alignment, using default parameter values. Note that the alignment will take several hours in this case.

5. After the alignment returns, next step is to compare nucleotide substitution models

4. .fasta file in R (see script) and saved it
I used the MAFFT program online to align the .fasta files under the default parameter values:
