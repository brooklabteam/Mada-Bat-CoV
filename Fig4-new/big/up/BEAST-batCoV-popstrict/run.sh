#!/bin/bash
#SBATCH --job-name=popstrictmadabatcovbeast
...
/global/home/users/cbrook/beast/bin/beast -beagle_cpu -seed 777 /global/scratch/users/cbrook/BEAST-batCoV-popstrict/MadaBatCoVpopstrict.xml
